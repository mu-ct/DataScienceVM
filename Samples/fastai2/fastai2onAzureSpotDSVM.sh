...
read -p "Azure VM Zone (default: westeurope): " vmzoneinput
vmzone=${vmzoneinput:=westeurope}
...
# You can find Azure size labels by running Azure CLI command in Cloud Shell "az vm list-sizes -l westeurope -o table"  
